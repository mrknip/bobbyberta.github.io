...
isNaN(a)||0===a)throw new Error("Invalid activityId supplied");if(b=b.toUpperCase(),"B"!==b&&"S"!==b&&"G"!==b)throw new Error("Invalid medal supplied");return{activityId:parseInt(a,10),medal:b}}},i=promise.Promise,j={get:promise.get,post:promise.post,put:promise.put},k="update",l="end",m="json",n="script",o=function(a){return"number"==typeof a&&a%1===0};if(!o(a))throw new Error("An int of Game Id must be passed as the first variable");if(b&&!o(b))throw new Error("An int or null of User Id must be passed as the second variable");var p=function(a){if(!a&&null!==a)throw new Error("An string of the Base Url must be provided to the initialisation")};p(c),p(d);var q={_gamePlayId:null,_levelId:null,_startPromises:{},_startPromiseIndex:0,init:function(){this._validateUser();var a=new i;return this._get(a,g.init,m),a},getAggregates:function(){this._validateUser();var a=new i;return this._get(a,g.aggregate,m),a},start:function(a){if(this._validateUser(),!o(a)&&!Array.isArray(a))throw new Error("Must pass a valid levelId to start a play");if(Array.isArray(a)&&0===a.length)throw new Error("Must pass a valid levelId to start a play");var b=new i,c=this,d={level:a};return this._gamePlayId&&(d.gamePlayId=this._gamePlayId),b.then(function(a,b){!a&&b.gamePlayId&&(c._gamePlayId=b.gamePlayId)}),this._post(b,g.start,d,m),this._levelId=a,++this._startPromiseIndex,this._startPromises[this._startPromiseIndex]=b,b},update:function(a,b,c){if(this._validateUser(),void 0===this._levelId)throw new Error("Start must be called before calling update");this._validateData(a);var d=this,e=new i,f=this._startPromiseIndex;return void 0===c?a.level=this._levelId:a.level=c,a.action=b,this._startPromises[this._startPromiseIndex].then(function(){d._put(e,g.update(d._gamePlayId),a,m),b===l&&delete d._startPromises[f]}),e},updateSettings:function(a){this._validateUser();var b=new i;return this._put(b,g.settings,a,m),b},getUser:function(a){var b=new i;return this._get(b,g.user(a),m),b},getExternalResource:function(a,b){var c=new i;return b===n?LazyLoad.js(a,function(){c.done()}):this._get(c,(d||"")+a,b),c},purchaseItem:function(a,b){this._validateUser(),o(b)||(b=1);var c=new i,d=this,e={itemId:a,quantity:b};return d._post(c,g.purchase,e,m),c},createImage:function(a,b,c){var d=new Image,e=this;if(b&&(d.onload=b),c&&(d.error=c),navigator.appVersion.indexOf("MSIE 10")!==-1){var f=new XMLHttpRequest;f.open("GET",a,!0),f.responseType="arraybuffer",f.onload=function(a){d.src="data:image/png;base64,"+e._base64ArrayBuffer(a.currentTarget.response)},f.send()}else d.crossOrigin="",d.src=a;return d},getLeaderboard:function(a,b){this._validateUser();var c=new i,d=this;return o(a)?d._get(c,g.leaderboard(a,b),m):d._get(c,g.gameLeaderboard(b),m),c},getLeaderboardOld:function(a){this._validateUser();var b=new i,c=this;return o(a)?c._get(b,g.leaderboardOld(a),m):c._get(b,g.gameLeaderboardOld,m),b},_validateUser:function(){if(!b)throw new Error("Must provide a user id to call this method")},_base64ArrayBuffer:function(a){for(var b,c,d,e,f,g="",h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",i=new Uint8Array(a),j=i.byteLength,k=j%3,l=j-k,m=0;m<l;m+=3)f=i[m]<<16|i[m+1]<<8|i[m+2],b=(16515072&f)>>18,c=(258048&f)>>12,d=(4032&f)>>6,e=63&f,g+=h[b]+h[c]+h[d]+h[e];return 1===k?(f=i[l],b=(252&f)>>2,c=(3&f)<<4,g+=h[b]+h[c]+"=="):2===k&&(f=i[l]<<8|i[l+1],b=(64512&f)>>10,c=(1008&f)>>4,d=(15&f)<<2,g+=h[b]+h[c]+h[d]+"="),g},_validateData:function(a){if(!o(a.balance))throw new Error("Must pass a valid balance property to update a play");if(!a.gameData||"object"!=typeof a.gameData)throw new Error("Must pass a gameData object to update a play");if(a.achievements)for(var b=0,c=a.achievements.length;b<c;++b){if(!o(a.achievements[b].activityId))throw new Error("Each achievement must have a valid activity id");if(!a.achievements[b].hasOwnProperty("medal")||[null,"B","S","G"].indexOf(a.achievements[b].medal)===-1)throw new Error("Each achievement must have a valid medal")}},_get:function(a,b,c,d){var f=this;return"undefined"==typeof d&&(d=1),j.get(b).then(function(g,h,i){g&&d<e?f._get(a,b,c,++d):a.done(g,f._convertType(h,c),i)}),a},_post:function(a,b,c,d,f){var g=this,h=JSON.stringify(c),i={"X-Checksum":this._createChecksum(h)};return"undefined"==typeof f&&(f=1),j.post(b,h,i).then(function(h,i,j){h&&f<e?g._post(a,b,c,d,++f):a.done(h,g._convertType(i,d),j)}),a},_put:function(a,b,c,d,f){var g=this,h=JSON.stringify(c),i={"X-Checksum":this._createChecksum(h)};return"undefined"==typeof f&&(f=1),j.put(b,h,i).then(function(h,i,j){h&&f<e?g._put(a,b,c,d,++f):a.done(h,g._convertType(i,d),j)}),a},_convertType:function(a,b){return b===m&&a?JSON.parse(a):a},_createChecksum:function(a){return md5(md5(a)+f)}};return h};var GreaterThan=GreaterThan||{};GreaterThan.UI={worldSizeX:2e3,worldSizeY:2e3},GreaterThan.CONFIG={bronzePoints:100,silverPoints:200,goldPoints:300,roundTime:18e4},GreaterThan.WORLDS={1:{name:"> Positive Integers",highestLevel:9,lowestLevel:0},2:{name:"< Positive Integers",highestLevel:19,lowestLevel:10},3:{name:"< and > Positive Integer",highestLevel:29,lowestLevel:20},4:{name:"> Integers",highestLevel:39,lowestLevel:30},5:{name:"< Integers",highestLevel:49,lowestLevel:40},6:{name:"< and > Integer",highestLevel:59,lowestLevel:50}},GreaterThan.LEVELS=[{levelName:"1:1",playerValue:5,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:10,proportionAbove:.3,proportionEqual:0,proportionBelow:.7}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"1:2",playerValue:10,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:20,proportionAbove:.3,proportionEqual:0,proportionBelow:.7}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"1:3",playerValue:10,equalTo:!0,greater:[{amount:10,minValue:0,maxValue:20,proportionAbove:.3,proportionEqual:.2,proportionBelow:.5}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"1:4",playerValue:10,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:20,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"1:5",playerValue:15,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:30,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"1:6",playerValue:15,equalTo:!0,greater:[{amount:10,minValue:0,maxValue:30,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"1:7",playerValue:15,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:30,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"1:8",playerValue:20,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:50,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"1:9",playerValue:20,equalTo:!0,greater:[{amount:10,minValue:0,maxValue:50,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"1:10",playerValue:20,equalTo:!1,greater:[{amount:15,minValue:0,maxValue:50,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"2:1",playerValue:5,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:10,proportionAbove:.7,proportionEqual:0,proportionBelow:.3}],treasure:[{text:"",value:0,amount:0}]},{levelName:"2:2",playerValue:10,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:15,proportionAbove:.7,proportionEqual:0,proportionBelow:.3}],treasure:[{text:"",value:0,amount:0}]},{levelName:"2:3",playerValue:10,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:20,proportionAbove:.3,proportionEqual:.2,proportionBelow:.5}],treasure:[{text:"",value:0,amount:0}]},{levelName:"2:4",playerValue:10,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:20,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"2:5",playerValue:15,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"2:6",playerValue:15,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"2:7",playerValue:15,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"2:8",playerValue:20,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"2:9",playerValue:20,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"2:10",playerValue:20,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:15,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"3:1",playerValue:5,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:0,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"",value:0,amount:0}]},{levelName:"3:2",playerValue:10,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:20,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:0,maxValue:20,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"",value:0,amount:0}]},{levelName:"3:3",playerValue:10,equalTo:!0,greater:[{amount:5,minValue:0,maxValue:20,proportionAbove:.3,proportionEqual:.2,proportionBelow:.5}],lesser:[{amount:5,minValue:0,maxValue:20,proportionAbove:.5,proportionEqual:.2,proportionBelow:.3}],treasure:[{text:"",value:0,amount:0}]},{levelName:"3:4",playerValue:10,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:20,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],lesser:[{amount:5,minValue:0,maxValue:20,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"3:5",playerValue:15,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],lesser:[{amount:5,minValue:0,maxValue:30,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"3:6",playerValue:15,equalTo:!0,greater:[{amount:5,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],lesser:[{amount:5,minValue:0,maxValue:30,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"3:7",playerValue:15,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:30,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],lesser:[{amount:5,minValue:0,maxValue:30,proportionAbove:0,proportionEqual:.5,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"3:8",playerValue:20,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:50,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],lesser:[{amount:5,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.5,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"3:9",playerValue:20,equalTo:!0,greater:[{amount:5,minValue:0,maxValue:50,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],lesser:[{amount:5,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.5,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"3:10",playerValue:20,equalTo:!1,greater:[{amount:7,minValue:0,maxValue:50,proportionAbove:.5,proportionEqual:.5,proportionBelow:0}],lesser:[{amount:7,minValue:0,maxValue:50,proportionAbove:0,proportionEqual:.5,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"4:1",playerValue:5,equalTo:!1,greater:[{amount:10,minValue:0,maxValue:10,proportionAbove:.3,proportionEqual:0,proportionBelow:.7}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"4:2",playerValue:0,equalTo:!1,greater:[{amount:10,minValue:-10,maxValue:10,proportionAbove:.3,proportionEqual:0,proportionBelow:.7}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"4:3",playerValue:0,equalTo:!0,greater:[{amount:10,minValue:-10,maxValue:10,proportionAbove:.3,proportionEqual:.2,proportionBelow:.5}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"",value:0,amount:0}]},{levelName:"4:4",playerValue:0,equalTo:!1,greater:[{amount:10,minValue:-10,maxValue:10,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"4:5",playerValue:-5,equalTo:!1,greater:[{amount:10,minValue:-15,maxValue:15,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"4:6",playerValue:-5,equalTo:!0,greater:[{amount:10,minValue:-15,maxValue:15,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:5},{text:"+2",value:2,amount:3},{text:"+3",value:3,amount:3}]},{levelName:"4:7",playerValue:-5,equalTo:!1,greater:[{amount:10,minValue:-15,maxValue:15,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"4:8",playerValue:-10,equalTo:!1,greater:[{amount:10,minValue:-25,maxValue:25,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"4:9",playerValue:-10,equalTo:!0,greater:[{amount:10,minValue:-25,maxValue:25,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"4:10",playerValue:-10,equalTo:!1,greater:[{amount:15,minValue:-25,maxValue:25,proportionAbove:.8,proportionEqual:.2,proportionBelow:0}],lesser:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"5:1",playerValue:5,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:0,maxValue:10,proportionAbove:.7,proportionEqual:0,proportionBelow:.3}],treasure:[{text:"",value:0,amount:0}]},{levelName:"5:2",playerValue:0,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-10,maxValue:10,proportionAbove:.7,proportionEqual:0,proportionBelow:.3}],treasure:[{text:"",value:0,amount:0}]},{levelName:"5:3",playerValue:0,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-10,maxValue:10,proportionAbove:.3,proportionEqual:.2,proportionBelow:.5}],treasure:[{text:"",value:0,amount:0}]},{levelName:"5:4",playerValue:0,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-10,maxValue:10,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"5:5",playerValue:-5,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-15,maxValue:15,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"5:6",playerValue:-5,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-15,maxValue:15,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"5:7",playerValue:-5,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-15,maxValue:15,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"5:8",playerValue:-10,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-25,maxValue:25,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"5:9",playerValue:-10,equalTo:!0,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:10,minValue:-25,maxValue:25,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"5:10",playerValue:-10,equalTo:!1,greater:[{amount:0,minValue:0,maxValue:0,proportionAbove:0,proportionEqual:0,proportionBelow:0}],lesser:[{amount:15,minValue:-25,maxValue:25,proportionAbove:0,proportionEqual:.2,proportionBelow:.8}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"6:1",playerValue:5,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:0,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"0",value:0,amount:0}]},{levelName:"6:2",playerValue:0,equalTo:!1,greater:[{amount:5,minValue:-10,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:-10,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"",value:0,amount:0}]},{levelName:"6:3",playerValue:0,equalTo:!0,greater:[{amount:5,minValue:-10,maxValue:10,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],lesser:[{amount:5,minValue:-10,maxValue:10,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],treasure:[{text:"",value:0,amount:0}]},{levelName:"6:4",playerValue:0,equalTo:!1,greater:[{amount:5,minValue:0,maxValue:20,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:-10,maxValue:10,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"6:5",playerValue:0,equalTo:!1,greater:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],lesser:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"6:6",playerValue:0,equalTo:!0,greater:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],lesser:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],treasure:[{text:"-1",value:-1,amount:5},{text:"-2",value:-2,amount:3},{text:"-3",value:-3,amount:3}]},{levelName:"6:7",playerValue:0,equalTo:!1,greater:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:-15,maxValue:15,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"6:8",playerValue:0,equalTo:!1,greater:[{amount:5,minValue:-25,maxValue:25,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],lesser:[{amount:5,minValue:-25,maxValue:25,proportionAbove:.5,proportionEqual:0,proportionBelow:.5}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"6:9",playerValue:0,equalTo:!0,greater:[{amount:5,minValue:-25,maxValue:25,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],lesser:[{amount:5,minValue:-25,maxValue:25,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]},{levelName:"6:10",playerValue:0,equalTo:!0,greater:[{amount:7,minValue:-25,maxValue:25,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],lesser:[{amount:7,minValue:-25,maxValue:25,proportionAbove:.25,proportionEqual:.5,proportionBelow:.25}],treasure:[{text:"+1",value:1,amount:1},{text:"+2",value:2,amount:2},{text:"+3",value:3,amount:3},{text:"-1",value:-1,amount:1},{text:"-2",value:-2,amount:2},{text:"-3",value:-3,amount:3}]}],testing=[{totalEaten:0,treasure:0,rightAnswers:0,wrongAnswers:0,pointsAtBronze:0,pointsAtSilver:0,pointsAtGold:0,worldWrap:!1,bronzePoints:3,silverPoints:4,goldPoints:5,treasurePoints:2,levelUpBonus:500}],player=[{currentLevel:0,currentWorld:0,startLevel:0,endLevel:0,levelLocation:0,levelMax:0,maxLevelLine:155,currentDepth:100,currentScore:0,totalScore:0,bronze:10,silver:20,gold:30,pauseEnabled:!0,language:"ENG_UK"}];var GreaterThan;!function(a){var b=function(c){b=function(f){c.call(this,{renderer:Phaser.CANVAS,parent:"canvasContainer"}),this.devicePixelRatio=Math.min(Math.round(window.devicePixelRatio),b.MAX_DPR)||1,this.apiManager=void 0,this.userManager=new a.Lib.UserManager(this),this.gameVars=f,this.userData={},this.readyToBoot=!1,this.state.add("boot",a.Boot),this.state.add("preloader",a.Preloader),this.state.add("title",a.Title),this.state.add("menu",a.Menu),this.state.add("settings",a.Settings),this.state.add("main",a.Main),this.state.add("gameOver",a.GameOver),d(this).then(function(a){e(this,a),this.play()}.bind(this))},b.prototype=Object.create(c.prototype),b.prototype.constructor=b,b.MAX_DPR=1,b.prototype.play=function(){this.readyToBoot===!0&&this.state.start("boot",!0)},b.prototype.boot=function(){c.prototype.boot.call(this),g(this)};var d=function(b){return b.apiManager=b.gameVars.userId?new a.Lib.ApiManager(b):new a.Lib.ApiGuestManager,new Promise(function(a,c){b.apiManager.init().then(function(b){a(b)})})},e=function(a,b){a.userManager.addUser(b),a.gameVars.activityId&&a.userManager.addChallenge(a.gameVars.activityId),a.readyToBoot=!0},f=function(a){return this.devicePixelRatio*a},g=function(a){var b,c,d=1024,e=768;if(window.innerHeight<e){var g=window.innerHeight/e;c=window.innerHeight,b=d*g}else b=d,c=e;a.scale.setGameSize(f(d),f(e)),a.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,a.scale.setMinMax(b,c,b,c)};return b}(Phaser.Game);a.Game=b}(GreaterThan||(GreaterThan={})),window.Game=GreaterThan.Game;var GreaterThan;!function(a){var b;!function(a){var b=function(){function a(a){this.game=a}return a.prototype.init=function(){return new Promise(function(a,b){a({guest:!0})})},a.prototype.savePreferences=function(a){},a.prototype.startLevel=function(a){},a.prototype.updateGameData=function(a){},a.prototype.handleWorldEnd=function(a){},a}();a.ApiGuestManager=b}(b=a.Lib||(a.Lib={}))}(GreaterThan||(GreaterThan={}));var GreaterThan;!function(a){var b;!function(a){var b=function(){function a(a){this.api=new MangahighGameAPI(a.gameVars.gameId,a.gameVars.userId,a.gameVars.baseUrl,a.gameVars.resourceUrl),this.game=a}return a.prototype.init=function(){return new Promise(function(a,b){this.api.init().then(function(b,c){a(c)})}.bind(this))},a.prototype.savePreferences=function(a){this.api.updateSettings(a)},a.prototype.startLevel=function(a){this.api.start(a)},a.prototype.updateGameData=function(a){var b=this._generatePostData(a);this.api.update(b)},a.prototype.handleWorldEnd=function(a,b){a.achievements&&(a.achievements=[this.api.createAchievement(b,a.achievements)]);var c=this._generatePostData(a);this.api.finish(c)},a.prototype._generatePostData=function(a){return{timePlayed:Math.floor(a.timePlayed/1e3)||30,score:a.gameData.currentScore||0,achievements:a.achievements||[],balance:a.balance||0,gameData:a.gameData||{},settings:a.settings,env:{}}},a}();a.ApiManager=b}(b=a.Lib||(a.Lib={}))}(GreaterThan||(GreaterThan={}));var GreaterThan;!function(a){var b;!function(a){var b=function(){function a(a){this.game=a}var b={settings:{fullscreen:!1,mute:!1,preferences:null,showTips:!0},user:{displayName:"Guest",school:"Mangahigh"},school:{name:"Mangahigh",locale:"en-GB"}},c={currentLevel:0,currentStage:0,startLevel:0,endLevel:0,timePlayer:0,levelLocation:0,maxLevelLine:155,currentDepth:100,currentScore:0,totalScore:0,bronze:10,silver:20,gold:30,pauseEnabled:!0,language:"ENG_UK",worldProgress:{1:{locked:!1,medal:null,score:0},2:{locked:!0,medal:null,score:0},3:{locked:!0,medal:null,score:0},4:{locked:!0,medal:null,score:0},5:{locked:!0,medal:null,score:0},6:{locked:!0,medal:null,score:0}}};a.prototype.init=function(){},a.prototype.addUser=function(a){return a.guest&&(a=b),a.gameData||(a.gameData=c),d(a,this.game.userData),this},a.prototype.addChallenge=function(a){this.game.userData.challengeMode=!0,this.game.userData.challengeId=a};var d=function(a,b){e(a,b,["settings","user","gameData","school","achievements"])},e=function(a,b,c){c.forEach(function(c){b[c]=a[c]})};return a}();a.UserManager=b}(b=a.Lib||(a.Lib={}))}(GreaterThan||(GreaterThan={}));var GreaterThan;!function(a){"use strict";var b=function(b){function c(){b.call(this,arguments)}return c.prototype=Object.create(Phaser.State.prototype),c.prototype.constructor=a.Boot,c.prototype.preload=function(){this.load.baseURL=this.game.gameVars.resourceUrl?this.game.gameVars.resourceUrl:"",this.load.json("asset-manifest","config/asset-manifest.json")},c.prototype.create=function(){this.stage.disableVisibilityChange=!0,this.game.renderer.renderSession.roundPixels=!0,this.game.state.start("preloader")},c}(Phaser.State);a.Boot=b}(GreaterThan||(GreaterThan={}));var GreaterThan=GreaterThan||{};
GreaterThan.GameOver=function(a){this.game=a},GreaterThan.GameOver.prototype={create:function(){this.gameData=this.game.userData.gameData,this.config={highScore:!1,medal:"none",clicked:!1},this.checkLanguage(),this._calculateHighScore(),this.addGraphics(),this._updateDataWithMedal(this.gameData.currentStage)},update:function(){},checkLanguage:function(){"pt-br"==this.game.userData.school.locale?(this.textGameOver=PTR_BR[0].gameOver[0].gameOver,this.textScore=PTR_BR[0].gameOver[0].score,this.textHighScore=PTR_BR[0].gameOver[0].highScore,this.textNext=PTR_BR[0].gameOver[0].next,this.textEarned=PTR_BR[0].gameOver[0].earned,this.textBronze=PTR_BR[0].gameOver[0].bronze,this.textSilver=PTR_BR[0].gameOver[0].silver,this.textGold=PTR_BR[0].gameOver[0].gold,this.textMedal=PTR_BR[0].gameOver[0].medal):(this.textGameOver=ENG_UK[0].gameOver[0].gameOver,this.textScore=ENG_UK[0].gameOver[0].score,this.textHighScore=ENG_UK[0].gameOver[0].highScore,this.textNext=ENG_UK[0].gameOver[0].next,this.textEarned=ENG_UK[0].gameOver[0].earned,this.textBronze=ENG_UK[0].gameOver[0].bronze,this.textSilver=ENG_UK[0].gameOver[0].silver,this.textGold=ENG_UK[0].gameOver[0].gold,this.textMedal=ENG_UK[0].gameOver[0].medal)},_calculateHighScore:function(){var a=this.gameData.currentStage;this.gameData.currentScore>this.gameData.worldProgress[a].score?(this.gameData.worldProgress[a].score=this.gameData.currentScore,this.config.highScore=!0,this._calculateMedal(a)):this.config.highScore=!1},_calculateMedal:function(a){var b=this.gameData.worldProgress[a].score;b>=GreaterThan.CONFIG.goldPoints?this.gameData.worldProgress[a].medal="G":b>=GreaterThan.CONFIG.silverPoints?this.gameData.worldProgress[a].medal="S":b>=GreaterThan.CONFIG.bronzePoints&&(this.gameData.worldProgress[a].medal="B")},addGraphics:function(){var a=this.gameData.currentStage;this.background=game.add.sprite(0,0,"splash");var b=1024,c=768;this.homeButton=game.add.button(b/2,c/2,"play",this._goHome),this.homeButton.anchor.setTo(.5,.5),this.nextText=this.add.text(0,0,this.textNext,{fill:"#24475b"}),this.nextText.anchor.setTo(.5,.5),this.homeButton.addChild(this.nextText),this.title=this.add.text(b/2,c/5,this.textGameOver,{fill:"#19a3e0"}),this.title.anchor.setTo(.5,.5),this.scoreBox=this.add.image(b/2,c/3,"title"),this.scoreBox.anchor.setTo(.5,.5),this.scoreText=this.make.text(5,5,this.textScore+": "+this.gameData.currentScore,{fill:"#24475b"}),this.scoreText.anchor.setTo(.5,.5),this.scoreBox.addChild(this.scoreText),this.createInformationBox(),this.information=game.add.sprite(b/1.05,c/1.1,"i"),this.information.anchor.setTo(.5,.5),this.information.inputEnabled=!0,this.information.events.onInputDown.add(function(){this._showInformation()},this),"G"==this.gameData.worldProgress[a].medal?this.medalText=this.textGold:"S"==this.gameData.worldProgress[a].medal?this.medalText=this.textSilver:"B"==this.gameData.worldProgress[a].medal&&(this.medalText=this.textBronze),1==this.config.highScore&&(this.highScore=this.add.text(b/2,c/2.5,this.textHighScore,{fill:"#19a3e0"}),this.highScore.anchor.setTo(.5,.5)),void 0!==this.medalText&&(this.highScore=this.add.text(b/2,c/1.5,this.textEarned+" "+this.medalText+" "+this.textMedal,{fill:"#19a3e0"}),this.highScore.anchor.setTo(.5,.5))},_goHome:function(){this.game.state.start("menu",!0)},showTestingData:function(){console.log("Stage "+player[0].currentStage+" report"),console.log("amount of right answers: "+testing[0].rightAnswers),console.log("amount of wrong answers: "+testing[0].wrongAnswers),console.log("total Eaten: "+testing[0].totalEaten),console.log("points earned at Bronze: "+testing[0].pointsAtBronze),console.log("points earned at Silver: "+testing[0].pointsAtSilver),console.log("points earned at Gold: "+testing[0].pointsAtGold);var a=player[0].currentLevel-player[0].startLevel;console.log("Highest Level: "+a),console.log("Treasure Eaten: "+testing[0].treasure),console.log("Level Up Bonus: "+testing[0].levelUpBoonus)},createInformationBox:function(){var a=this.gameData.currentLevel-this.gameData.startLevel,b=this.gameData.currentStage,c=a+1;this.informBox=this.add.image(200,150,"box1"),this.textGroup=this.add.group();var d=260,e=240;this.height=0,this.title=this.make.text(440,180,"Stage "+b+" Points Break Down:",{fill:"#6f9695"}),this.textGroup.add(this.title),this._addInformationText(d,e,"Amount of right answers: ",testing[0].rightAnswers),this._addInformationText(d,e,"Amount of wrong answers: ",testing[0].wrongAnswers),this._addInformationText(d,e,"Total Eaten: ",testing[0].totalEaten),this._addInformationText(d,e,"Points earned at Bronze: ",testing[0].pointsAtBronze),this._addInformationText(d,e,"Points earned at Silver: ",testing[0].pointsAtSilver),this._addInformationText(d,e,"Points earned at Gold: ",testing[0].pointsAtGold),this._addInformationText(d,e,"Highest Level Reached: ",c),this._addInformationText(d,e,"Bubbles Collected: ",testing[0].treasure),this._addInformationText(d,e,"Level Up Bonus Points:  ",testing[0].levelUpBoonus),this.textGroup.visible=!1,this.informBox.visible=!1},_addInformationText:function(a,b,c,d){var e=b+this.height;this.text=this.make.text(a,e,c+d,{fill:"#6f9695"}),this.textGroup.add(this.text),this.height+=40},_showInformation:function(){0==this.config.clicked?(this.informBox.visible=!0,this.textGroup.visible=!0,this.config.clicked=!0):(this.informBox.visible=!1,this.textGroup.visible=!1,this.config.clicked=!1)},_updateDataWithMedal:function(a){this.game.apiManager.handleWorldEnd({timePlayed:this.gameData.timePlayed,gameData:this.gameData,achievements:this.gameData.worldProgress[this.gameData.currentStage].medal},a)}},GreaterThan.Main=function(a){this.game=a},GreaterThan.Main.prototype={config:{viewSizeX:1024,viewSizeY:768,worldSizeX:GreaterThan.UI.worldSizeX,worldSizeY:GreaterThan.UI.worldSizeY,coolDownTime:.5,arrowMove:75,lineMove:75,rightInARow:6,wrongInARow:3,unlockLevel:10,minutes:0,seconds:30},testingData:{},gameState:{},preload:function(){},create:function(){this.gameData=this.game.userData.gameData,this.userInfo=this.game.userData.user,this.userSettings=this.game.userData.settings,this.checkLanguage(),this.addGameInformation(),this._initGameInformation(),this.addTestingData(),this.addWorld(),this.addTreasure(),this.addGreaterLesserEntities(),this.addPlayer(),this.addUI(),this.addTimer(GreaterThan.CONFIG.roundTime),this.animateFuel(),this.game.time.advancedTiming=!0,this._notifyLevelStart(this.gameData.currentStage)},update:function(){this._playerMovement(this.gameState.playerSpeed),this.collisionDetection()},render:function(){1==this.timer.running?game.debug.text(this._formatTime(Math.round((this.timerEvent.delay-this.timer.ms)/1e3)),540,35,"#fff"):game.debug.text("GameOver!",600,60,"#fff"),game.debug.text(game.time.fps||"--",5,20,"#00ff00")},checkLanguage:function(){"pt-br"==this.game.userData.school.locale?(this.textStage=PTR_BR[0].game[0].stage,this.textScore=PTR_BR[0].game[0].score,this.textPauseMenu=PTR_BR[0].game[0].pause,this.textQuit=PTR_BR[0].game[0].quit,this.textContinue=PTR_BR[0].game[0].continue):(this.textStage=ENG_UK[0].game[0].stage,this.textScore=ENG_UK[0].game[0].score,this.textPauseMenu=ENG_UK[0].game[0].pause,this.textQuit=ENG_UK[0].game[0].quit,this.textContinue=ENG_UK[0].game[0].continue)},addGameInformation:function(){var a=this.gameData.currentLevel,b=this.gameData.currentStage;this.gameState={levelName:GreaterThan.LEVELS[a].levelName,worldSizeX:this.config.worldSizeX,worldSizeY:this.config.worldSizeY,equalToLevel:GreaterThan.LEVELS[a].equalTo,pauseEnabled:player[0].pauseEnabled,depth:player[0].currentDepth,backgroundColour:"#6f9695",currentStage:b,currentLevel:a,lowestLevel:GreaterThan.WORLDS[b].lowestLevel,highestLevel:GreaterThan.WORLDS[b].highestLevel,score:this.gameData.currentScore,toNextLevel:this.config.unlockLevel,playerCurrentValue:GreaterThan.LEVELS[a].playerValue,alive:!0,playerSpeed:500,levelUp:0,levelDown:0,levelLocation:player[0].levelLocation,maxLevel:player[0].maxLevel,maxLevelLine:player[0].maxLevelLine,greaterMinValue:GreaterThan.LEVELS[a].greater[0].minValue,greaterMaxValue:GreaterThan.LEVELS[a].greater[0].maxValue,greaterAmount:GreaterThan.LEVELS[a].greater[0].amount,greaterPropAbove:GreaterThan.LEVELS[a].greater[0].proportionAbove,greaterPropEqual:GreaterThan.LEVELS[a].greater[0].proportionEqual,greaterPropBelow:GreaterThan.LEVELS[a].greater[0].proportionBelow,greater:[],lesserMinValue:GreaterThan.LEVELS[a].lesser[0].minValue,lesserMaxValue:GreaterThan.LEVELS[a].lesser[0].maxValue,lesserAmount:GreaterThan.LEVELS[a].lesser[0].amount,lesserPropAbove:GreaterThan.LEVELS[a].lesser[0].proportionAbove,lesserPropEqual:GreaterThan.LEVELS[a].lesser[0].proportionEqual,lesserPropBelow:GreaterThan.LEVELS[a].lesser[0].proportionBelow,lesser:[],treasure:[],paused:!1}},_initGameInformation:function(){this.gameData.timePlayed=0,this.gameState.score=0},_refreshGameInformation:function(){this.gameState.levelUp=0,this.gameState.levelDown=0},addTestingData:function(){testing[0].totalEaten=0,testing[0].treasure=0,testing[0].rightAnswers=0,testing[0].wrongAnswers=0,testing[0].pointsAtBronze=0,testing[0].pointsAtSilver=0,testing[0].pointsAtGold=0,testing[0].levelUpBoonus=0,this.testing={treasure:testing[0].totalEaten,rightAnswers:testing[0].rightAnswers,wrongAnswers:testing[0].wrongAnswers,pointsAtBronze:testing[0].pointsAtBronze,pointsAtSilver:testing[0].pointsAtSilver,pointsAtGold:testing[0].pointsAtGold,levelUpBoonus:testing[0].levelUpBoonus}},addWorld:function(){this.game.world.setBounds(0,0,this.gameState.worldSizeX,this.gameState.worldSizeY),this.bounds=new Phaser.Rectangle(0,0,this.gameState.worldSizeX,this.gameState.worldSizeY),this.background=game.add.image(0,0,"bgBase"),this.background.fixedToCamera=!0,this.background3=game.add.image(0,0,"bgMiddle"),this.background2=game.add.image(0,0,"bgTop"),this.background2.fixedToCamera=!0,this.lightAnim=game.add.sprite(0,0,"light"),this.lightAnim.fixedToCamera=!0;var a=this.lightAnim.animations.add("twinkle");a.enableUpdate=!0,this.game.cursors=this.game.input.keyboard.createCursorKeys()},_addBackgroundColour:function(){this._defineBackground(),this.game.stage.backgroundColor=this.gameState.backgroundColour},_defineBackground:function(){var a=this.gameState.currentLevel-this.gameState.lowestLevel;0==a?this.gameState.backgroundColour="#z6f9695":1==a?this.gameState.backgroundColour="#56908E":2==a?this.gameState.backgroundColour="#4D8B86":3==a?this.gameState.backgroundColour="#418481":4==a?this.gameState.backgroundColour="#377F7B":5==a?this.gameState.backgroundColour="#327A76":6==a?this.gameState.backgroundColour="#307571":7==a?this.gameState.backgroundColour="#2E716C":8==a&&(this.gameState.backgroundColour="#2C6C68")},addTimer:function(a){this.timer=game.time.create(),this.timerSound=this.timer.add(a-11*Phaser.Timer.SECOND,this._timerSound,this),this.timerEvent=this.timer.add(a,this._endTimer,this),this.timer.start()},_formatTime:function(a){var b="0"+Math.floor(a/60),c="0"+(a-60*b);return b.substr(-2)+":"+c.substr(-2)},_timerSound:function(){this.addSFX("timer")},_endTimer:function(){this._updateGameData(),this.addTestingInformation(),this.timer.stop(),this.game.state.start("gameOver",!0)},addUI:function(){var a={fill:"#ffffff",align:"center",wordWrap:!0,wordWrapWidth:200};this._addTitle(a),this._addScore(a),this._addFuelBar(),this._addHomeButton(),this._addPauseMenu()},_addTitle:function(a){this.levelTitle=this.add.image(0,0,"scoreBox"),this._setUIPosition(this.levelTitle,10,20),this.titleText=this.make.text(5,5,this.gameState.levelName,a),this.titleText.anchor.setTo(.5,.5),this.levelTitle.addChild(this.titleText)},_addScore:function(a){this.scoreBox=this.add.image(0,0,"scoreBox"),this._setUIPosition(this.scoreBox,10,8),this.scoreText=this.make.text(5,5,this.gameState.score,a),this.scoreText.anchor.setTo(.5,.5),this.scoreBox.addChild(this.scoreText)},_addFuelBar:function(){this.fuelBase=this.add.image(0,0,"fuelBase"),this.fuelBase.fixedToCamera=!0,this.fuelBase.cameraOffset.setTo(250,30),this.fuelBase.anchor.setTo(0,.5),this.fuelMid=this.add.image(10,0,"fuelMid"),this.fuelMid.anchor.setTo(0,.5),this.fuelBase.addChild(this.fuelMid),this.fuelTop=this.add.image(10,0,"fuelTop"),this.fuelTop.anchor.setTo(0,.5),this.fuelBase.addChild(this.fuelTop)},animateFuel:function(){game.add.tween(this.fuelTop.scale).to({x:0,y:1},GreaterThan.CONFIG.roundTime,null,!0,0,1/0)},_addDepthUi:function(){this.depthUI=this.add.image(0,0,"depth"),this.depthUI.scale.setTo(1.2,1.5),this._setUIPosition(this.depthUI,150,80),this.arrow=this.add.image(0,0,"arrow"),this._setUIPosition(this.arrow,115,this.gameState.depth),this.deepestDepth=this.add.image(0,0,"deepestLine"),this.deepestDepth.scale.setTo(1.2,1.5),this._setUIPosition(this.deepestDepth,145,this.gameState.maxLevelLine)},_addHomeButton:function(){this.homeButton=game.add.sprite(40,700,"home"),this._setUIPosition(this.homeButton,1.05,15),this.homeButton.inputEnabled=!0,this.homeButton.events.onInputDown.add(function(){this._pause()},this)},_setUIPosition:function(a,b,c){a.fixedToCamera=!0;var d=this.config.viewSizeX,e=this.config.viewSizeY;a.cameraOffset.setTo(d/b,e/c),a.anchor.setTo(.5,.5)},_goHome:function(){this.gameData.currentScore=this.gameState.score,this.addTestingInformation(),this.timer.stop(),game.physics.arcade.isPaused=!game.physics.arcade.isPaused,this.game.state.start("gameOver",!0)},_pause:function(){game.physics.arcade.isPaused=!game.physics.arcade.isPaused,0==this.gameState.paused?(this.pauseGroup.visible=!0,this.gameState.paused=!0):(this.pauseGroup.visible=!1,this.gameState.paused=!1)},_addPauseMenu:function(){this.pauseGroup=this.add.group(),this.box=this.add.image(0,0,"helpBox"),this._setUIPosition(this.box,2,2),this.pauseGroup.add(this.box),this.quitButton=game.add.sprite(0,0,"play2"),this._setUIPosition(this.quitButton,3.5,2),this.quitButton.inputEnabled=!0,this.quitButton.events.onInputDown.add(function(){this._goHome()},this),this.pauseGroup.add(this.quitButton),this.continueButton=game.add.sprite(0,0,"play2"),this._setUIPosition(this.continueButton,1.4,2),this.continueButton.inputEnabled=!0,this.continueButton.events.onInputDown.add(function(){this._pause()},this),this.pauseGroup.add(this.continueButton),this._addPauseText(this.textPauseMenu,"#213f6b",2,4),this._addPauseText(this.textQuit,"#19a3e0",3.5,2),this._addPauseText(this.textContinue,"#19a3e0",1.4,2),this.pauseGroup.add(this.box),this.pauseGroup.visible=!1},_addPauseText:function(a,b,c,d){var e={fill:b,align:"centre"};this.pauseText=game.add.text(0,0,a,e),this.pauseText.anchor.setTo(.5,.5),this.pauseGroup.add(this.pauseText),this._setUIPosition(this.pauseText,c,d)},addPlayer:function(){this.player=this.add.sprite(this.config.worldSizeX/2,this.config.worldSizeY/2,""),this._addSlowCircle(),this._addMediumCircle(),this.physics.enable(this.player,Phaser.Physics.ARCADE),this.player.anchor.setTo(.5,.5),this.game.camera.follow(this.player),1==testing[0].worldWrap?this.game.camera.bounds=null:(this.game.camera.bounds=this.bounds,this.player.body.collideWorldBounds=!0,this.player.body.bounce.x=1,this.player.body.bounce.y=1,this.player.body.minBounceVelocity=0),this.sub=this.add.sprite(-1.5,-12,"sub"),this.sub.anchor.setTo(.53,.5),this.player.addChild(this.sub),this.playerNumberBase=this.make.text(-11,-15,this.gameState.playerCurrentValue,{fill:"#FFFFFF"}),this.playerNumber=this.make.text(-9,-13,this.gameState.playerCurrentValue,{fill:"#000000"}),this.player.addChild(this.playerNumber),this.player.addChild(this.playerNumberBase)},_addSlowCircle:function(){this.slowCircle=this.add.sprite(this.config.worldSizeX/2,this.config.worldSizeY/2,""),this.physics.enable(this.slowCircle,Phaser.Physics.ARCADE),this.slowCircle.body.setSize(150,150),this.slowCircle.anchor.setTo(2.5,2.5)},_addMediumCircle:function(){this.mediumCircle=this.add.sprite(this.config.worldSizeX/2,this.config.worldSizeY/2,""),this.physics.enable(this.mediumCircle,Phaser.Physics.ARCADE),this.mediumCircle.body.setSize(300,300),this.mediumCircle.anchor.setTo(4.5,4.5)},_playerMovement:function(a){var b=game.input.x+game.camera.x,c=game.input.y+game.camera.y;Phaser.Rectangle.contains(this.player.body,b,c)?(this.player.body.velocity.setTo(0,0),this.slowCircle.body.velocity.setTo(0,0),this.mediumCircle.body.velocity.setTo(0,0)):Phaser.Rectangle.contains(this.slowCircle.body,b,c)?(game.physics.arcade.moveToPointer(this.player,a/2),game.physics.arcade.moveToPointer(this.slowCircle,a/2),game.physics.arcade.moveToPointer(this.mediumCircle,a/2)):Phaser.Rectangle.contains(this.mediumCircle.body,b,c)?(game.physics.arcade.moveToPointer(this.player,a/1.5),game.physics.arcade.moveToPointer(this.slowCircle,a/1.5),game.physics.arcade.moveToPointer(this.mediumCircle,a/1.5)):(game.physics.arcade.moveToPointer(this.player,a),game.physics.arcade.moveToPointer(this.slowCircle,a),game.physics.arcade.moveToPointer(this.mediumCircle,a)),this.checkAnimation(this.player,this.sub)},checkAnimation:function(a,b){var c=a.body.x;game.time.events.add(.1*Phaser.Timer.SECOND,function(){this._updateAnimation(c,a.body.x,b)},this)},_updateAnimation:function(a,b,c){var d=b;a>d?c.scale.x=1:a<d&&(c.scale.x=-1)},_playerMovementMouse:function(a){this.game.input.activePointer.isDown?(this.game.physics.arcade.moveToPointer(this.player,a),Phaser.Rectangle.contains(this.player.body,game.input.x,game.input.y)&&this.player.body.velocity.setTo(0,0)):this.player.body.velocity.setTo(0,0)},_playerMovementArrows:function(a){},addGreaterLesserEntities:function(){this._createGreater(this.gameState.greater,this.gameState.greaterAmount),this._createLesser(this.gameState.lesser,this.gameState.lesserAmount)},_createGreater:function(a,b){this._calculateValue(a,b,this.gameState.greaterMinValue,this.gameState.playerCurrentValue-1,this.gameState.greaterPropBelow),this._calculateValue(a,b,this.gameState.playerCurrentValue+1,this.gameState.greaterMaxValue,this.gameState.greaterPropAbove),this._calculateValue(a,b,this.gameState.playerCurrentValue,this.gameState.playerCurrentValue,this.gameState.greaterPropEqual)},_createLesser:function(a,b){this._calculateValue(a,b,this.gameState.lesserMinValue,this.gameState.playerCurrentValue-1,this.gameState.lesserPropBelow),this._calculateValue(a,b,this.gameState.playerCurrentValue+1,this.gameState.lesserMaxValue,this.gameState.lesserPropAbove),this._calculateValue(a,b,this.gameState.playerCurrentValue,this.gameState.playerCurrentValue,this.gameState.lesserPropEqual)},_calculateValue:function(a,b,c,d,e){var f=game.rnd.integerInRange(c,d);this._calculateAmount(a,b,c,d,e,f)},_calculateAmount:function(a,b,c,d,e,f){var g=b*e,b=game.math.roundTo(g,0);this._createAmountOfEntities(a,b,c,d,f)},_createAmountOfEntities:function(a,b,c,d,e){this.objectGroup=this.add.group(),this.objectGroup.enableBody=!0,this.objectGroup.inputEnabled=!0,this.objectGroup.physicsBodyType=Phaser.Physics.ARCADE;for(var f=0;f<b;f++)this._createEntities(a,this.objectGroup,c,d,e)},_createEntities:function(a,b,c,d,e){e=game.rnd.integerInRange(c,d),this._defineImage(a,e),this.object=this.objectGroup.create(this.bounds.randomX,this.bounds.randomY,image),this.object.anchor.setTo(.5,.5),this.object.value=e,0==testing[0].worldWrap&&this._addGroupPhysics(this.objectGroup),this._addFish(this.object,headImage,finImage,tailImage),this._addFishNumber(this.object,e,a),this._addSpeed(this.object),a.push(this.object)},_addFish:function(a,b,c,d){this.fishBase=this.add.sprite(0,0,image),this.fishBase.anchor.setTo(.5,.5),a.addChild(this.fishBase),this._addFishDetail(this.fishBase,b,c,d)},_addFishDetail:function(a,b,c,d){this.fishHead=this.add.sprite(-40,0,b),this.fishHead.anchor.setTo(1,.5),a.addChild(this.fishHead),this.fishFin=this.add.sprite(0,-45,c),this.fishFin.anchor.setTo(.5,1),a.addChild(this.fishFin),this.fishTail=this.add.sprite(40,0,d),this.fishTail.anchor.setTo(0,.5),a.addChild(this.fishTail)},_addFishNumber:function(a,b,c){this.fishCircle=this.add.image(0,0,"number"),this.fishCircle.anchor.setTo(.5,.5),a.addChild(this.fishCircle),this._addText(a,b),this._addMathsSign(c,a)},_addSpeed:function(a){a.body.velocity.x=game.rnd.integerInRange(-100,100),a.body.velocity.y=game.rnd.integerInRange(-100,100)},_addMathsSign:function(a,b){if(1==this.gameState.equalToLevel)var c="equalTo";else var c="sign";a==this.gameState.greater?(this.mathSign=this.add.image(-8,0,c),this.mathSign.anchor.setTo(.5,.5),this.fishCircle.addChild(this.mathSign)):(this.mathSign=this.add.image(-8,0,c),this.mathSign.anchor.setTo(.5,.5),this.mathSign.scale.x*=-1,this.fishCircle.addChild(this.mathSign))},_addText:function(a,b){this.text=this.make.text(12,0,b,{fill:"#213f6b"}),this.text.anchor.setTo(.5,.5),a.addChild(this.text)},_defineImage:function(a,b){if(a==this.gameState.greater)var c=this.gameState.greaterMinValue,d=this.gameState.greaterMaxValue,e=game.math.roundTo(d-c,0);else if(a==this.gameState.lesser)var c=this.gameState.lesserMinValue,d=this.gameState.lesserMaxValue,e=game.math.roundTo(d-c,0);var f=game.math.roundTo(e/3,0),g=d-f,h=d-2*f;a==this.gameState.greater?b>=g?(image="fishC",headImage="headC",finImage="finC",tailImage="tailC"):b>=h?(image="fishB",headImage="headB",finImage="finB",tailImage="tailB"):b>=c&&(image="fishA",headImage="headA",finImage="finA",tailImage="tailA"):a==this.gameState.lesser&&(b>=g?(image="fishA",headImage="headA",finImage="finA",tailImage="tailA"):b>=h?(image="fishB",headImage="headB",finImage="finB",tailImage="tailB"):b>=c&&(image="fishC",headImage="headC",finImage="finC",tailImage="tailC"))},_addGroupPhysics:function(a){this.physicsGroup=this.game.make.group(),a.add(this.physicsGroup),a.setAll("body.collideWorldBounds",!0),a.setAll("body.bounce.x",1),a.setAll("body.bounce.y",1),a.setAll("body.minBounceVelocity",0)},addTreasure:function(){for(var a=GreaterThan.LEVELS[this.gameState.currentLevel].treasure,b=0;b<a.length;++b){var c=a[b];this._createAmountOfTreasure(c.amount,this.gameState.treasure,c.value,c.text,"treasure")}},_createAmountOfTreasure:function(a,b,c,d,e){this.treasureGroup=this.add.group(),this.treasureGroup.enableBody=!0,this.treasureGroup.physicsBodyType=Phaser.Physics.ARCADE;for(var f=0;f<a;f++)this._createTreasure(b,c,d,e)},_createTreasure:function(a,b,c,d){this.treasure=this.treasureGroup.create(this.bounds.randomX,this.bounds.randomY,d),this.treasure.value=b,this.treasure.text=c,this._addGroupPhysics(this.treasureGroup),this._addTreasureSpeed(this.treasure),this._addTreasureText(this.treasure,c),a.push(this.treasure)},_addTreasureText:function(a,b){this.text=this.make.text(5,5,b,{fill:"#24475b"}),a.addChild(this.text)},_addTreasureSpeed:function(a){a.body.velocity.x=game.rnd.integerInRange(-50,50),a.body.velocity.y=game.rnd.integerInRange(-50,50)},collisionDetection:function(){1==this.gameState.alive&&(this._checkGreater(),this._checkLesser(),this._checkTreasure())},_checkGreater:function(){for(var a=0;a<this.gameState.greater.length;++a){var b=this.gameState.greater[a],c=a;1==testing[0].worldWrap&&game.world.wrap(b),this.checkAnimation(b,b.children[0]),this.game.physics.arcade.overlap(this.player,b,function(a,d){this._greaterCollided(d,c,b,b.value)},null,this)}},_checkLesser:function(){for(var a=0;a<this.gameState.lesser.length;++a){var b=this.gameState.lesser[a],c=a;1==testing[0].worldWrap&&game.world.wrap(b),this.game.physics.arcade.overlap(this.player,b,function(a,d){this._lesserCollided(d,c,b,b.value)},null,this)}},_checkTreasure:function(){for(var a=0;a<this.gameState.treasure.length;++a){var b=this.gameState.treasure[a],c=a;1==testing[0].worldWrap&&game.world.wrap(b),this.game.physics.arcade.overlap(this.player,b,function(a,d){this._treasureCollided(d,c,b.value)},null,this)}},_greaterCollided:function(a,b,c,d){if(1==this.gameState.equalToLevel&&this.gameState.playerCurrentValue<d)this._wrongAnswer(a);else if(0==this.gameState.equalToLevel&&this.gameState.playerCurrentValue<=d)this._wrongAnswer(a);else{if(1==this.gameState.equalToLevel)var e="greaterEqual",f="≥",g=this.gameState.playerCurrentValue;else var e="greater",f=">",g=this.gameState.playerCurrentValue-1;this._addEntityPoints(a),a.kill(),this.gameState.greater.splice(b,1),this._rightAnswer(this.gameState.greaterMinValue,g,d,f,this.gameState.greater,1,e)}},_lesserCollided:function(a,b,c,d){if(1==this.gameState.equalToLevel&&this.gameState.playerCurrentValue>d)this._wrongAnswer(a);else if(0==this.gameState.equalToLevel&&this.gameState.playerCurrentValue>=d)this._wrongAnswer(a);else{if(1==this.gameState.equalToLevel)var e="lesserEqual",f="≤",g=this.gameState.playerCurrentValue;else var e="lesser",f="<",g=this.gameState.playerCurrentValue+1;this._addEntityPoints(a),a.kill(),this.gameState.lesser.splice(b,1),this._rightAnswer(g,this.gameState.lesserMaxValue,d,f,this.gameState.lesser,1,e)}},_treasureCollided:function(a,b,c){this.addSFX("pop"),this.gameState.playerCurrentValue+=c,this.addPoints(testing[0].treasurePoints),this.testing.treasure+=1,a.kill(),this.gameState.treasure.splice(b,1),this.playerNumber.setText(this.gameState.playerCurrentValue),this.playerNumberBase.setText(this.gameState.playerCurrentValue)},updateLevelUp:function(){this.gameState.levelUp+=1,this.gameState.levelDown=0,this._checkChangeLevel()},_updateLevelDown:function(){this.gameState.levelUp=0,this.gameState.levelDown+=1,this._checkChangeLevel()},_checkChangeLevel:function(){this.gameState.levelUp==this.config.rightInARow&&this.gameState.currentLevel<this.gameState.highestLevel&&(this.gameState.levelLocation==this.gameState.maxLevel&&(2==this.gameState.currentLevel&&(this.addPoints(testing[0].levelUpBonus),this.testing.levelUpBoonus+=testing[0].levelUpBonus),5==this.gameState.currentLevel&&(this.addPoints(testing[0].levelUpBonus),this.testing.levelUpBoonus+=testing[0].levelUpBonus),7==this.gameState.currentLevel&&(this.addPoints(testing[0].levelUpBonus),this.testing.levelUpBoonus+=testing[0].levelUpBonus),this.gameState.maxLevel+=1),this.gameState.levelLocation+=1,this.gameData.currentLevel+=1,this.addSFX("win"),this._levelChangeScreen()),this.gameState.levelDown==this.config.wrongInARow&&this.gameState.currentLevel>this.gameState.lowestLevel&&(this.addSFX("wave"),this._levelChangeScreen(),this.gameData.currentLevel-=1,this.gameState.levelLocation-=1)},_removeGreaterLesser:function(a){for(var b=0;b<a.length;++b){var c=a[b];c.kill()}for(var b=0;b<a.length;++b)a.splice(b)},_levelChangeScreen:function(){this._lotsOfBubbles(),game.time.events.add(0*Phaser.Timer.SECOND,this._removeEntities,this)},_lotsOfBubbles:function(){for(var a=0,b=0;b<150;b++){this.bubble=game.add.sprite(-100+this.bounds.randomX,2500,"bubble"),this.bubble.scale.set(game.rnd.realInRange(.01,.1));var c=game.rnd.between(3e3,8e3);game.add.tween(this.bubble).to({y:-256},c,Phaser.Easing.Sinusoidal.InOut,!0),a+=200}},_removeEntities:function(){this.gameState.currentLevel>=this.gameState.lowestLevel&&this.gameState.currentLevel<=this.gameState.highestLevel&&(this._removeGreaterLesser(this.gameState.greater),this._removeGreaterLesser(this.gameState.lesser),this._removeGreaterLesser(this.gameState.treasure),game.time.events.add(4.5*Phaser.Timer.SECOND,this._nextLevel,this),this.addTestingInformation())},_nextLevel:function(){this._addToPlayerInformation(),this._updateGameData(),this.addGameInformation(),this._addBackgroundColour(),this.addGreaterLesserEntities(),this.addTreasure(),this._setNewLevelText()},_setNewLevelText:function(){this.playerNumber.setText(this.gameState.playerCurrentValue),this.playerNumberBase.setText(this.gameState.playerCurrentValue),this.titleText.setText(this.gameState.levelName),this.scoreText.setText(this.gameState.score)},_addToPlayerInformation:function(){if(6!==this.gameState.currentStage&&this.gameState.score>=this.gameState.toNextLevel){var a=this.gameState.currentStage+1;this.gameData.worldProgress[a].locked=!1}},_checkMoveUpDown:function(){this.gameState.levelUp==this.config.rightInARow&&(this.gameData.currentLevel+=1,player[0].currentLevel+=1),this.gameState.levelDown==this.config.wrongInARow&&this.gameData.currentLevel>0&&(this.gameData.currentLevel-=1,player[0].currentLevel-=1)},addPoints:function(a){this.gameState.score+=a,this.scoreText.setText(this.gameState.score)},_wrongAnswer:function(a){this.addSFX("splash"),this._animateFishEscape(a),this._died(),this._updateLevelDown(),this.testing.wrongAnswers+=1},_animateFishEscape:function(a){this.fade=game.add.tween(a).to({alpha:.5},1,Phaser.Easing.Linear.None,!0),this.fade.onComplete.add(this._unfade,this)},_unfade:function(a){this.game.add.tween(a).to({alpha:1},3e3,Phaser.Easing.Linear.None,!0)},_rightAnswer:function(a,b,c,d,e,f,g){this.addSFX("tick"),this.minValue=a,this.maxValue=b,this._textSolvedAnimation(c,d),this._createAmountOfEntities(e,1,a,b,c),this.updateLevelUp(),this.testing.rightAnswers+=1},_textSolvedAnimation:function(a,b){this.solvedEquation=game.add.text(this.player.x,this.player.y,this.gameState.playerCurrentValue+b+a,{fill:"#24475b"}),game.add.tween(this.solvedEquation).to({alpha:0},3e3,Phaser.Easing.Linear.None,!0)},_died:function(){this.gameState.alive=!1,this.game.time.events.add(Phaser.Timer.SECOND*this.config.coolDownTime,this._reBorn,this)},_reBorn:function(){this.gameState.alive=!0,this.player.frame=0},_addEntityPoints:function(a){"fishA"==a.key?this.addPoints(3):"fishB"==a.key?this.addPoints(4):"fishC"==a.key&&this.addPoints(5)},_notifyLevelStart:function(a){this.game.apiManager.startLevel(a)},_updateGameData:function(){this.gameData.currentScore=this.gameState.score,this.gameData.timePlayed=this.timer.ms,this.game.apiManager.updateGameData({timePlayed:this.gameData.timePlayed,gameData:this.gameData,settings:this.userSettings,user:this.userInfo})},addTestingInformation:function(){var a=this.testing.rightAnswers+this.testing.wrongAnswers;testing[0].totalEaten=a,testing[0].treasure=this.testing.treasure,testing[0].rightAnswers=this.testing.rightAnswers,testing[0].wrongAnswers=this.testing.wrongAnswers,testing[0].pointsAtBronze=this.testing.pointsAtBronze,testing[0].pointsAtSilver=this.testing.pointsAtSilver,testing[0].pointsAtGold=this.testing.pointsAtGold,testing[0].levelUpBoonus=this.testing.levelUpBoonus},showTestingData:function(){console.log("amount of right answers: "+testing[0].rightAnswers),console.log("amount of wrong answers: "+testing[0].wrongAnswers),console.log("total Eaten: "+testing[0].totalEaten),console.log("points earned at Bronze: "+testing[0].pointsAtBronze),console.log("points earned at Silver: "+testing[0].pointsAtSilver),console.log("points earned at Gold: "+testing[0].pointsAtGold);var a=player[0].currentLevel-player[0].startLevel;console.log("Highest Level: "+a),console.log("Treasure Eaten: "+testing[0].treasure),console.log("Level Up Bonus: "+testing[0].levelUpBoonus)},addSFX:function(a){this.sound=game.add.audio(a),this.sound.play()}},GreaterThan.Menu=function(a){this.game=a},GreaterThan.Menu.prototype={config:{settingsClicked:!1,checkBoxTicked:!1,worldSize:"small",worldSelected:!1},preload:function(){},create:function(){this.gameData=game.userData.gameData,this.checkLanguage(),this.background=game.add.sprite(0,0,"splash");var a=this.background.width/2,b=this.background.height/5;this.titleText=this.add.text(a,b,this.textTitle,{fill:"#19a3e0",align:"center",wordWrap:!0,wordWrapWidth:this.background.width}),this.titleText.anchor.setTo(.5,.5),this.background.addChild(this.titleText),this.addLevels(),this.game.userData.challengeMode&&this._startLevel(this.game.userData.challengeId)},update:function(){},checkLanguage:function(){"pt-br"==this.game.userData.school.locale?(this.textTitle=PTR_BR[0].menu[0].title,this.textWorld=PTR_BR[0].menu[0].world,this.textWorld1=PTR_BR[0].menu[0].world1,this.textWorld2=PTR_BR[0].menu[0].world2,this.textWorld3=PTR_BR[0].menu[0].world3,this.textWorld4=PTR_BR[0].menu[0].world4,this.textWorld5=PTR_BR[0].menu[0].world5,this.textWorld6=PTR_BR[0].menu[0].world6,this.textPlay=PTR_BR[0].menu[0].play,this.textFuel=PTR_BR[0].menu[0].fuel,this.textFish=PTR_BR[0].menu[0].fish):(this.textTitle=ENG_UK[0].menu[0].title,this.textWorld=ENG_UK[0].menu[0].world,this.textWorld1=ENG_UK[0].menu[0].world1,
this.textWorld2=ENG_UK[0].menu[0].world2,this.textWorld3=ENG_UK[0].menu[0].world3,this.textWorld4=ENG_UK[0].menu[0].world4,this.textWorld5=ENG_UK[0].menu[0].world5,this.textWorld6=ENG_UK[0].menu[0].world6,this.textPlay=ENG_UK[0].menu[0].play,this.textFuel=ENG_UK[0].menu[0].fuel,this.textFish=ENG_UK[0].menu[0].fish)},addLevels:function(){var a=250,b=500,c=200,d=425,e=650;this._addLevel(c,a,1,this.textWorld1),this._addLevel(d,a,2,this.textWorld2),this._addLevel(e,a,3,this.textWorld3),this._addLevel(c,b,4,this.textWorld4),this._addLevel(d,b,5,this.textWorld5),this._addLevel(e,b,6,this.textWorld6)},_addLevel:function(a,b,c,d){this.gameData.worldProgress[c].locked===!1?(this._addButton(a,b,c,d),this._addMedal(c)):game.add.sprite(a,b,"locked")},_addButton:function(a,b,c,d){this.levelButton=game.add.sprite(a,b,"unlocked"),this.levelButton.inputEnabled=!0,this.levelButton.events.onInputDown.add(function(){this._startLevel(c)},this);var e={fill:"#213f6b",align:"center",wordWrap:!0,wordWrapWidth:this.levelButton.width},f=this.levelButton.width/2,g=this.levelButton.height/5,h=this.levelButton.height/1.8,i=this.levelButton.height/1.2;this.text=game.add.text(f,g,d,e),this.text.anchor.setTo(.5,.5),this.levelButton.addChild(this.text),this.stageScore=this.make.text(f,h,this.gameData.worldProgress[c].score,e),this.stageScore.anchor.setTo(.5,.5),this.levelButton.addChild(this.stageScore),this.stars=game.add.sprite(f,i,"stars"),this.stars.anchor.setTo(.5,.5),this.levelButton.addChild(this.stars)},_addMedal:function(a){var b=this.gameData.worldProgress[a].medal;"G"==b?this.stars.frame=3:"S"==b?this.stars.frame=2:"B"==b?this.stars.frame=1:this.stars.frame=0,this.levelButton.addChild(this.stars)},_startLevel:function(a){game.world.removeAll(),this.game.stage.backgroundColor="#213f6b",this.checkLanguage(),this._setGameData(a),this.addStartWorld(a)},_setGameData:function(a){this.gameData.currentStage=a,this.gameData.currentLevel=GreaterThan.WORLDS[a].lowestLevel,this.gameData.startLevel=GreaterThan.WORLDS[a].lowestLevel},addStartWorld:function(a){this.box=this.add.image(0,0,"helpBox"),this._setScreenPosition(this.box,2,2),this._addTitle(a),this._addFuel(),this._addFish(),this._addPlayButton()},_addTitle:function(a){if(6==a)var b=this.textWorld6;else if(5==a)var b=this.textWorld5;else if(4==a)var b=this.textWorld4;else if(3==a)var b=this.textWorld3;else if(2==a)var b=this.textWorld2;else var b=this.textWorld1;var c={fill:"#213f6b"};this.title=this.add.text(0,0,this.textWorld+a+": "+b,c),this._setScreenPosition(this.title,2,7)},_addFuel:function(){var a={fill:"#213f6b",align:"center",wordWrap:!0,wordWrapWidth:this.box.width};this.fuelText=game.add.text(0,0,this.textFuel+": 4mins",a),this._setScreenPosition(this.fuelText,4,4)},_addFish:function(){var a={fill:"#213f6b",align:"center",wordWrap:!0,wordWrapWidth:this.box.width};this.fishText=game.add.text(0,0,this.textFish,a),this._setScreenPosition(this.fishText,4,3)},_addPlayButton:function(){this.playButton=this.add.sprite(0,0,"play2"),this._setScreenPosition(this.playButton,2,1.25),this.playButton.inputEnabled=!0,this.playButton.events.onInputDown.add(function(){this._playGame()},this),this.playButton.anchor.setTo(.5,.5);var a={fill:"#19a3e0",align:"center",wordWrap:!0,wordWrapWidth:this.playButton.width};this.playText=game.add.text(0,0,this.textPlay,a),this.playText.anchor.setTo(.5,.5),this.playButton.addChild(this.playText)},_setScreenPosition:function(a,b,c){a.anchor.setTo(.5,.5),a.fixedToCamera=!0;var d=1025,e=768;a.cameraOffset.setTo(d/b,e/c)},_playGame:function(){this.game.state.start("main",!0)}},GreaterThan=GreaterThan||{},GreaterThan.Preloader=function(a){},GreaterThan.Preloader.prototype={preload:function(){this.loadingVisualizer=new GreaterThan.Lib.PreloadVisualizer(this.game);var a=this.cache.getJSON("asset-manifest");for(var b in a.images)a.images.hasOwnProperty(b)&&this.game.load.image(b,a.images[b]);game.load.image("title","assets2/scoreUI.png");for(var c in a.audio)a.audio.hasOwnProperty(c)&&this.game.load.audio(c,a.audio[c]);this.game.load.spritesheet("unlocked","assets2/levelBox.png"),this.game.load.spritesheet("stars","assets2/starSprites.png",160,60,4),this.game.load.spritesheet("light","assets2/lightAnim.png",1024,768,3),this.game.load.spritesheet("you","assets/player.png",75,75,4)},create:function(){this.input.maxPointers=1,this.disableVisibilityChange=!0,this.loadingVisualizer.setFillPercent(100);var a=this.add.tween(this.loadingVisualizer).to({alpha:0},500,Phaser.Easing.Linear.None,!0);a.onComplete.add(function(){this.game.state.start("title")},this)},loadUpdate:function(){this.loadingVisualizer.setFillPercent(this.load.progress)}},GreaterThan=GreaterThan||{},GreaterThan.Title=function(a){},GreaterThan.Title.prototype={config:{helpClicked:!1},create:function(){this.checkLanguage(),this.background=game.add.sprite(0,0,"splash");var a=this.background.width/2,b=this.background.height/3;this.titleImage=game.add.sprite(a,b,"titleImage"),this._addText(this.titleImage,this.textTitle),this.addButton(),this.titleImage.anchor.setTo(.5,.5),this.background.addChild(this.titleImage),this.addHelpMenu()},update:function(){},checkLanguage:function(){"pt-br"==this.game.userData.school.locale?(this.textPlay=PTR_BR[0].title[0].play,this.textHelp=PTR_BR[0].title[0].help,this.textTitle=PTR_BR[0].title[0].title):(this.textPlay=ENG_UK[0].title[0].play,this.textHelp=ENG_UK[0].title[0].help,this.textTitle=ENG_UK[0].title[0].title)},addHelpMenu:function(){var a=this.background.width/2,b=this.background.height/2;this.helpGroup=this.add.group(),this.helpBg=this.add.image(a,b,"helpBox"),this.helpTitle=game.add.text(a-20,b-275,this.textHelp,{fill:"#213f6b"}),this.helpGroup.add(this.helpBg),this.helpGroup.add(this.helpTitle),this.helpGroup.visible=!1,this.helpBg.anchor.setTo(.5,.5)},addButton:function(){var a=this.background.width/2,b=this.background.height/3;this._playButton(a,2*b,"play",this.textPlay),this._helpButton(a,2.5*b,"help",this.textHelp)},_playButton:function(a,b,c,d){this.button=game.add.sprite(a,b,c),this.button.inputEnabled=!0,this.button.events.onInputDown.add(function(){this._playGame()},this),this.button.anchor.setTo(.5,.5),this._addText(this.button,d)},_helpButton:function(a,b,c,d){this.button=game.add.sprite(a,b,c),this.button.inputEnabled=!0,this.button.events.onInputDown.add(function(){this._checkHelpClicked()},this),this.button.anchor.setTo(.5,.5),this._addText(this.button,d)},_addText:function(a,b){var c={fill:"#213f6b",align:"center",wordWrap:!0,wordWrapWidth:a.width};this.text=game.add.text(0,0,b,c),this.text.anchor.setTo(.5,.5),a.addChild(this.text)},_playGame:function(){this.game.state.start("menu",!0)},_checkHelpClicked:function(){0==this.config.helpClicked?(this.config.helpClicked=!0,this.helpGroup.visible=!0):(this.config.helpClicked=!1,this.helpGroup.visible=!1)}},GreaterThan=GreaterThan||{},ENG_UK=[{title:[{play:"Play",help:"Help",title:"Greater Than You"}],menu:[{title:"Choose a World:",world:"World ",world1:"Coral Reef",world2:"Kelp Forest",world3:"Ship Wreck",world4:"The Abyss",world5:"Volcano",world6:"Atlantis",play:"Play",fuel:"Fuel",fish:"Fish"}],game:[{stage:"Stage",score:"Score",pause:"Paused",quit:"Quit?",continue:"Play On?"}],gameOver:[{gameOver:"Game Over",score:"Score",highScore:"High Score",next:"Next",earned:"You have earned a",bronze:"bronze",silver:"silver",gold:"gold",medal:"medal"}]}],PTR_BR=[{title:[{play:"Jogar",help:"Ajuda",title:"Greater Than You"}],menu:[{title:"Escolher um Mundo:",world:"World ",world1:"Recife de corais",world2:"Floresta de Algas",world3:"Naufrágio",world4:"O Abismo",world5:"Vulcão",world6:"Atlantis",play:"Jogar",fuel:"Combustível",fish:"Peixe"}],game:[{stage:"Etapa",score:"Ponto",pause:"Pausa",quit:"Desistir?",continue:"Jogar Em?"}],gameOver:[{gameOver:"Fim de Jogo",score:"Partitura",highScore:"Pontuação Máxima",next:"Seguinte",earned:"Você ganhou um",bronze:"Bronze",silver:"Prata",gold:"Ouro",medal:"Medalha"}]}];var GreaterThan;!function(a){var b;!function(a){var b=function(){function a(a){this.width=120,this.height=140,this.dppx=1,this.game=a,this.dppx=a.devicePixelRatio;var b="mh-preloader",c=this.p(this.width),d=this.p(this.height),e=c/2,f=new Phaser.BitmapData(this.game,b,c,d),g=f.ctx;g.fillStyle="#ff9800",g.beginPath(),g.moveTo(e,0),g.lineTo(c,this.p(17)),g.lineTo(this.p(109),this.p(127)),g.lineTo(e,d),g.lineTo(e,this.p(126)),g.lineTo(this.p(96),this.p(114)),g.lineTo(this.p(104),this.p(27)),g.lineTo(e,this.p(14)),g.lineTo(e,0),g.fill(),g.fillStyle="#f16c00",g.beginPath(),g.moveTo(e,0),g.lineTo(0,this.p(17)),g.lineTo(this.p(10),this.p(127)),g.lineTo(e,d),g.lineTo(e,this.p(126)),g.lineTo(this.p(24),this.p(114)),g.lineTo(this.p(16),this.p(27)),g.lineTo(e,this.p(14)),g.lineTo(e,0),g.fill(),g.fillStyle="#ffffff",g.beginPath(),g.moveTo(e,this.p(14)),g.lineTo(this.p(104),this.p(27)),g.lineTo(this.p(96),this.p(114)),g.lineTo(e,this.p(126)),g.lineTo(this.p(24),this.p(114)),g.lineTo(this.p(16),this.p(27)),g.lineTo(e,this.p(14)),g.lineTo(e,this.p(20)),g.lineTo(this.p(23),this.p(31)),g.lineTo(this.p(30),this.p(111)),g.lineTo(e,this.p(119)),g.lineTo(this.p(90),this.p(111)),g.lineTo(this.p(97),this.p(31)),g.lineTo(e,this.p(20)),g.lineTo(e,this.p(14)),g.fill(),this.fillableArea=new Phaser.BitmapData(a,"mh-preloader-filler",c,d),this.fillImg=a.add.image(a.world.centerX,a.world.centerY,this.fillableArea),this.fillImg.anchor.x=.5,this.fillImg.anchor.y=.5,this.baseImg=a.add.image(a.world.centerX,a.world.centerY,f),this.baseImg.anchor.x=.5,this.baseImg.anchor.y=.5,this.fillerGradient=g.createLinearGradient(0,0,0,d),this.fillerGradient.addColorStop(0,"#59b0f6"),this.fillerGradient.addColorStop(1,"#1a71c6")}return a.prototype.setFillPercent=function(a){var b=this.fillableArea.ctx,c=this.p(105),d=this.p(119),e=c/100*a,f=d-e,g=this.p(9),h=this.p(this.width),i=h/2;a>=70&&(g*=1-(a-70)/30),this.fillableArea.clear(),b.fillStyle=this.fillerGradient,b.beginPath(),b.moveTo(i,this.p(119)),b.lineTo(this.p(90),this.p(111)),b.lineTo(this.p(104),f),b.lineTo(i,f+g),b.lineTo(this.p(15),f),b.lineTo(this.p(30),this.p(111)),b.lineTo(i,this.p(119)),b.fill()},a.prototype.p=function(a){return this.dppx*a},a}();a.PreloadVisualizer=b}(b=a.Lib||(a.Lib={}))}(GreaterThan||(GreaterThan={}));